...
CORES = {
    ...
    'Verde': {
        'faixas': [(np.array([40, 60, 60]), np.array([85, 255, 255]))],
        'bgr': (0, 200, 0),
    },
    'Azul': {
        'faixas': [(np.array([100, 80, 50]), np.array([130, 255, 255]))],
        'bgr': (220, 0, 0),
    },
    'Amarelo': {
        'faixas': [(np.array([20, 100, 100]), np.array([35, 255, 255]))],
        'bgr': (0, 220, 220),
    },
    'Laranja': {
        'faixas': [(np.array([10, 130, 130]), np.array([20, 255, 255]))],
        'bgr': (0, 120, 255),
    },
}
