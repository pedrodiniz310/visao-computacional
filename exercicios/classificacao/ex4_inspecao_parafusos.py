...
IMAGENS = [
    '../../imagens/parafusos1.png',
    '../../imagens/parafusos2.png',
    '../../imagens/parafusos3.png',
]
...
def processar_parafusos(caminho: str):
    ...
    # Morfologia: fechar buracos menores que o kernel antes de analisar peças
    ...
    # RETR_CCOMP: nível 0 = objetos externos | nível 1 = furos (filhos)
