...
# cv2.split(): separa a imagem BGR em 3 arrays de 1 canal cada
# b=canal 0 (azul), g=canal 1 (verde), r=canal 2 (vermelho)
b, g, r = cv2.split(imagem)

# cv2.equalizeHist(): equaliza o histograma de 1 canal (uint8 obrigatório)
# Redistribui os pixels para cobrir uniformemente [0-255]
b_eq = cv2.equalizeHist(b)
g_eq = cv2.equalizeHist(g)
r_eq = cv2.equalizeHist(r)

# cv2.merge(): junta 3 arrays de 1 canal em 1 array de 3 canais (BGR)
